...
Падтрымка Windows 10 яшчэ патрабуе праверкі на прыладах. Для H.264/AAC выкарыстоўваюцца сістэмныя кодэкі; іншыя фарматы могуць патрабаваць дадатковых кодэкаў. Для ўбудаваных вэб-прайгравальнікаў патрэбны WebView2 Runtime. Мінімальная версія Android — 8.0.

## Структура рэпазіторыя

| Шлях | Прызначэнне |
|---|---|
| `core/` | Агульны стан праграмы, каманды, захоўванне даных, спампоўкі і C ABI |
...
```sh
pacman -S --needed make curl tar diffutils mingw-w64-ucrt-x86_64-gcc mingw-w64-ucrt-x86_64-pkgconf mingw-w64-ucrt-x86_64-libxml2 mingw-w64-ucrt-x86_64-zlib mingw-w64-ucrt-x86_64-libass
```
