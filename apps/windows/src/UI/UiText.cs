...
public static class Ui
{
    ...
    public static string MediaStatus(string? status) => (status ?? "").Trim().ToLowerInvariant() switch
    {
        ...
        "anons" or "announced" or "upcoming" or "not_yet_aired" => "Анансавана",
    ...
    [
        ...
        ("Польша", "Польшча"),
        ("Франция", "Францыя"),
        ("Великобритания", "Злучанае Каралеўства"),
        ("Германия", "Нямеччына"),
        ("Италия", "Італія"),
        ("Канада", "Канада"),
        ("Тайвань", "Тайвань"),
    ...
    private static readonly Dictionary<string, string> GenreMap = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["школа"] = "школа",
        ["school"] = "школа",
        ["повседневность"] = "штодзённасць",
        ["slice of life"] = "штодзённасць",
        ["психологический"] = "псіхалагічнае",
        ["psychological"] = "псіхалагічнае",
        ["исторический"] = "гістарычнае",
