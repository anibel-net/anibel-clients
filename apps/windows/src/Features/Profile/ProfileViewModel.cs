...
public partial class ProfileViewModel : ObservableObject
{
    ...
    public async Task LoadProfileAsync(string? username = null)
    {
        ...
        try
        {
            var result = await _core.CallAsync<ProfileViewDto>(CoreCommand.Profile, new { username });
    ...
    {
        var result = await _core.CallAsync<ProfileDto>(CoreCommand.UpdateProfile, patch);
        Profile = result;
    ...
    public async Task LoadHubAsync()
    {
        ...
        try
        {
            var hub = await _core.CallAsync<ProfileHubDto>(CoreCommand.ProfileHub);
