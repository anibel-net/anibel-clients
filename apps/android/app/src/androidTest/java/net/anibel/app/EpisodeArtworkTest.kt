...
class EpisodeArtworkTest {
    ...
    @Test fun sharedCoreReturnsRealEpisodeScreenshots() = runBlocking {
        ...
        val info = core.call(CoreCommand.VideoInfo, json("videoId" to "4624f156-b4f3-4b19-9e0c-ec559a038c57"))
        ...
        val relativeInfo = core.call(CoreCommand.VideoInfo, json("videoId" to "09af99c7-e69c-4de0-a010-0e6826c5241f"))
